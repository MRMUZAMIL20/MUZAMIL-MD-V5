...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/MRMUZAMIL20/MUZAMIL-MD/main/data/version.json';
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/MRMUZAMIL20/MUZAMIL-MD';

    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ ᴍᴜᴢᴀᴍɪʟ-ᴍᴅ ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ ᴍᴜᴢᴀᴍɪʟ-ᴍᴅ ʙᴏᴛ ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: '☇ ᴍᴜᴢᴀᴍɪʟ̇ ᴍᴅ sᴘᴏʀᴛs  ⃪🤖͎᪳᪳𝆺𝅥',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
