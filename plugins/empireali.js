...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "923198746597@s.whatsapp.net", // Replace with staff contact numbers
                "923198746597@s.whatsapp.net", // Example: Add staff members here
                "923198746597@s.whatsapp.net", // Example: Add staff members here
                "923198746597@s.whatsapp.net", // Example: Add staff members here
                "923198746597@s.whatsapp.net", // Example: Add staff members here
                "923198746597@s.whatsapp.net", // Example: Add staff members here
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "𓆩ု᪳𝐌𝐔𝐙𝐀𝐌𝐈𝐋-𝐌𝐃ှ᪳𓆪";
