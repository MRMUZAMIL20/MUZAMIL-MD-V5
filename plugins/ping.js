        ...
        await conn.sendMessage(from, { 
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '𝐌𝐔𝐙𝐀𝐌𝐈𝐋 𝐌Ɗ 𝐏๏፝֟ƞ̽g  ⃪🤖͎᪳᪳𝆺𝅥',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
    ...
    try {
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363297843078852@newsletter',
                    newsletterName: "𝐌𝐔𝐙𝐀𝐌𝐈𝐋̇ 𝐌Ɗ 𝐏๏፝֟ƞ̽g  ⃪🤖͎᪳᪳𝆺𝅥",
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        const startTime = Date.now()
        const message = await conn.sendMessage(from, { text: '\`MUZAMIL PINGING 🚀\`' })
        const endTime = Date.now()
        const ping = endTime - startTime
        await conn.sendMessage(from, { text: `*MUZAMIL PONGED ! : ${ping}ms ⚡*` }, { quoted: message })
    } catch (e) {
        console.log(e)
        reply(`${e}`)
    }
